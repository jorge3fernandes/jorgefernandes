...
function map() {
    ...
    if ($('#' + mapId).length > 0) {
        ...
        if (mapMarker) {
            ...
            marker.bindPopup("<div class='p-4'><h5>This is where you'll find me most of the time</h5><p>If you're in the Harford, CT area, reach out and let's grab some tea and talk AI.</p></div>", {
                minwidth: 200,
                maxWidth: 600,
